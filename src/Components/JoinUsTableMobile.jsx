...
import JoinUsTableRows from "./JoinUsTableRows";
const JoinUsMobileTable = function () {
            ...
            {contacts.map((contact) => (
              <>
                {editContactId === contact.id ? (
                  ...
                  <JoinUsTableRows contact={contact} />
                )}
              </>
            ))}
          </tbody>
...
export default JoinUsMobileTable;
