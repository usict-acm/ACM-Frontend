export const updateObjState = (setter: any, model: any, prop: any, val: any) => {
    let _model = Object.assign({}, model)
    _model[prop] = val
    setter(_model)
}
export const updateArrOfObjState = (setter: any, model: any, index: any, prop: any, val: any) => {
    let _model = [...model]
...
export const arrayToggle = (arr: any, item: any) => {
...
export const getDateFromMillis = (milliseconds: number) => {
    let date = new Date(milliseconds)
    return date.toLocaleString()
}

export const expired = (createDateMillis: number, hours: string) => {
...
export const createFillableModel = (model: any) => {
    let fillableModel = []
...
export const createSubmitableModel = (fields: any) => {
    let submitableModel = []
    for (let field in fields) {
        let fld = fields[field]
...
export const hasError = (fields: any) => {
